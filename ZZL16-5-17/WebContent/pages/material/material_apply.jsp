...
<body class="skin-blue">
									...
									<div class="col-md-5">
										<div class="box-body">
											<label>预定时间</label> <input type="text"
												class="form-control form-input date" id="matrialApplyDate" placeholder="yyyy-mm-dd" name="matrialApplyDate"
												value="${matrialApplyDate}"> 
										</div>
									</div>
									<div class="col-md-2">
	...
	<div class="modal fade" id="MaterialDetail" tabindex="-1" role="dialog"
		...
		$('#matrialApplyDate').datetimepicker({
			language : 'zh-CN',
			format : 'yyyy-mm-dd',
			weekStart : 1,
			todayBtn : 1,
