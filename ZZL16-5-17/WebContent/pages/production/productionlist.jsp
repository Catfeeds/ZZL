				...
				<div class="row">
					...
					<div class="input-group">
						<label for="customer_brand">客户名：</label> <input
							id="customer_brand" type="text" class="form-control form-input"
							placeholder="客户名" maxlength="20" name="customerBrand"
							value="${customerBrand}">
					</div>
					...
					<div class="input-group">
						<label for="customer_representative">客户代表：</label> <input
							...
							class="form-control form-input" placeholder="客户代表" maxlength="20"
							name="customerRepresentative" value="${customerRepresentative}">
					</div>
					<div class="form-group">
						<label for="accessory_state">辅料采购状况：</label> <select
							id="accessory_state" class="form-control" name="accessoryState">
							<option>请选择</option>
				...
				<div class="row">
					...
					<div class="form-group">
						<label for="production_state">排单状态：</label> <select
							id="production_state" class="form-control" name="productionState">
							<option>请选择</option>
							<option>未排单</option>
							<option>已排单</option>
						</select>
								...
								<td>
									...
									<p>
										<s:set
											...
											var="designnewold" />
										<s:if test="#production.designNewOld.equals(#designnewold[0])">
											<span class="red">
										</s:if>
										<s:else>
											<span class="green">
