			...
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<form role="form" method="post"
						action="<%=request.getContextPath()%>/Technique/addTechnique?tech_list_size=" id="addTechnique">
						<!-- 新增款式工艺单  -->
						<div class="row">
							<div class="col-md-8">
							...
							<table class="table table-striped" id="tech_list">
								...
								<tbody >
									<tr id="0">
										...
										<td><input type="text" class="form-control" id="list-0-partName" name="list-0-partName"></td>
										...
										<td><input type="text" class="form-control" id="list-0-InTolerance" name="list-0-InTolerance"></td>
									</tr>
								</tbody>
							</table>
							<!-- /.table -->
						...
						<div class="row">
							...
							<div class="table-responsive" style="margin: 0px 50px 50px 23px">
								<table class="table table-striped" id="tech_inventory">
									...
									<tr>
										<td><input type="text" class="form-control" id="tech_apart" name="tech_apart"></td>
										<td><input type="text" class="form-control" id="specific_tech" name="specific_tech"></td>
	...
	<script>
		...
		var add_tech_list = function(){
			...
			$("#tech_list").append("<tr id="+new_len+">"
					...
					+"<td> <input type='text' class='form-control' id='list-"+new_len+"-partName' name='list-"+new_len+"-partName'></td>"
					...
					+ "<option>XXL</option>"
					+ "</select></td>"
					+ "<td> <input type='text' class='form-control' id='list-"+new_len+"-InTolerance' name='list-"+new_len+"-InTolerance'></td></tr>");
		}
			...
			for(var i=index+1;i<_len;i++){
				...
				$("tr[id=\'" + i + "\']")
                			.replaceWith("<tr id="+(i-1)+">"
                					...
                					+"<td> <input type='text' class='form-control' id='list-"+(i-1)+"-partName' value='"+nextPartName+"' name='list-"+(i-1)+"-partName'></td>"
                					...
                					+ "<option>XXL</option>"
                					+ "</select></td>"
                					+ "<td> <input type='text' class='form-control' id='list-"+(i-1)+"-InTolerance' value='"+nextInTolerance+"' name='list-"+(i-1)+"-InTolerance'></td></tr>");
				$("#list-"+(i-1)+"-MCode").val(nextMCode);
			}
			var new_len = _len-1;
			$("tr[id='"+_len+"']").replaceWith("<tr id="+new_len+">"
					+"<td><a id='addTable' class='btn btn-success' onclick='add_tech_list()'><i class='fa fa-plus'></i></a></td>"
					+"<td> <input type='text' class='form-control' id='list-"+new_len+"-partName' value='"+lastPartName+"'  name='list-"+new_len+"-partName'></td>"
					+ "<td><select class='form-control' id='list-"+new_len+"-MCode' name='list-"+new_len+"-MCode'>"
					+ "<option>XS</option>"
					+ "<option>S</option>"
					+ "<option>M</option>"
					...
					+ "<option>XXL</option>"
					+ "</select></td>"
					+ "<td> <input type='text' class='form-control' id='list-"+new_len+"-InTolerance' value='"+lastInTolerance+"' name='list-"+new_len+"-InTolerance'></td></tr>");
