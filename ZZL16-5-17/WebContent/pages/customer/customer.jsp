...
<head>
    ...
    <script language="javascript">
    	function searchCustomer(){
    		f.action="<%=request.getContextPath()%>/Customer/showSearchedCustomers";
    		document.f.submit();
    	}
    	function examineCustomer(){
    		f.action="<%=request.getContextPath()%>/Customer/exmineCustomer";
    		document.f.submit();
    	}
    	function deleteCustomer(){
    		f.action="<%=request.getContextPath()%>/Customer/deleteCustomer";
    		document.f.submit();
    	}
    </script>
     -->
                                    ...
                                    <!-- form start -->
                                      <form  role="form" method="post" action="<%=request.getContextPath()%>/Customer/showSearchedCustomers">                    
                                        ...
                                        <div class="row" >
                                                ...
                                                <div class="col-md-3">                                                   
                                                     <input type="text" class="form-control" id="customerBrandName" name="customerBrandName">
                                                </div>
