			...
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<!-- form start -->
							<form action="<%=request.getContextPath()%>/Process/queryProcessor" method="post">
								<div class="row">
									<div class="col-md-6">
										<div class="box-body">
											<label>加工方名称： </label> <input type="text" class="form-control"
												name="processorName" value=${processorName}> 
										</div>
									</div>
									<div class="col-md-2">
						...
						<div class="col-md-2">
							<div class="row">
								<button type="button" class="btn btn-warning"
									style="margin: 5px 5px 5px 75px" data-toggle="modal" data-target="#addProcessor">新增</button>
							</div>
							<div class="row">
								<button type="button" class="btn btn-primary"
									style="margin: 5px 5px 15px 75px" data-toggle="modal" onclick="receiveModel()">收货</button>
							</div>
						</div>
							...
							<table class="table table-striped">
								...
								<s:iterator value="PageBean.list" var="processorItem">
									<tr onclick="javascript:judgeSelected(this)">
										<td><input type="radio" name="select"> <input type="hidden" name="selectedCode" value=${processorItem.processorCode} ></td>
										...
										<td><s:property value="#processorItem.processorMobileNum" /></td>
										<td><s:property value="#processorItem.processorAddr" /></td>
										<td><s:property value="#processorItem.processorDistrict" /></td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="table" style="margin-top: 10px;">
						...
						<form action="<%=request.getContextPath()%>/Process/addProcessor" method="post">
							<table class="table" rules="none" frame="void">
								...
								<tr>
									...
									<td><input type="text" style="width: 50%" name="new_WorkerNum"></td>
								</tr>
								<tr>
									<td>加工方区域<span style="color: red">*</span>：
									</td>
									<td colspan="3"><input type="text" style="width: 95%" name="new_District"></td>
	...
	<div class="modal fade" id="newReceive" tabindex="-1" role="dialog"
						...
						<!-- .table - Uses sparkline charts-->
							<table class="table" rules="none" frame="void">
								<tr>
									...
									<td>外发单号：</td>
									<td><input type="text" id="outsource_Code" ></td>
									<td style="width:40px"></td>
									<td><button type="button" class="btn btn-danger" onclick="newReceive()" style="margin:auto">
											收货</button></td>
								</tr>
    	...
    	<script type="text/javascript">
        	...
        	function newReceive(){
        		...
        		if(os_code != null){
        			location.href= getRootPath() + "/pages/process/receive_new.jsp?pcode="+p_code+"&oscode="+os_code; 
        		}
        	}
