...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <form  role="form" method="post" action="<%=request.getContextPath()%>/Design_Order/addOrder">
                        ...
                        <table class="table" id="infoTable">
                          <tbody>
                             ...
                             <tr>
                              ...
                              <tr>
                                <td>参考网址：</td>
                                <td><input type="text" class="form-control" id="orderRefURL"name="orderRefURL" placeholder="参考网址" style="float:left;padding: 2px 10px;width:500px" maxlength="30"></td>
                             </tr>
                          </tbody>
                        </table>       
                        <div class="png_area">
                            ...
                            <table class="table table-striped" id="tab-materaildetail">
                              ...
                              <%--  <td><s:select list="supplyList" name="materialdetails_add[0].materialName"   
								...
								<td><input type="text" name="materialdetails_add[0].orderMaterialAttr"
										...
										<td><select name="materialdetails_add[0].materialName"  style="width:100px" id="detail-0-1">
										<s:iterator value="supplyList" var="supply"><option><s:property value="#supply.material.materialName"/></option></s:iterator></select></td>
										<td><input type="text" name="materialdetails_add[0].orderMaterialAttr"
											id="detail-0-2"   style="width:100px"></td>
										<td><select name="materialdetails_add[0].materialType"  style="width:100px" id="detail-0-3">
										<s:iterator value="supplyList" var="supply"><option><s:property value="#supply.material.materialType"/></option></s:iterator></select></td>
										<td><select name="materialdetails_add[0].colorCode"  style="width:100px" id="detail-0-4">
										<s:iterator value="supplyList" var="supply"><option><s:property value="#supply.material.colorCode"/></option></s:iterator></select></td>
										<td><select name="materialdetails_add[0].vendorName"  style="width:100px" id="detail-0-5">
										<s:iterator value="supplyList" var="supply"><option><s:property value="#supply.vendor.vendorName"/></option></s:iterator></select></td>
										<td><input type="text" name="materialdetails_add[0].orderVol"
											id="detail-0-6" value="0" style="width:100px"></td>
										<td><input type="text" name="materialdetails_add[0].orderComment"
											id="detail-0-7" value="" style="width:100px"></td>
...
function addMaterialDetail(){
    ...
    $("#detail-"+_len+"-3").attr("readonly","readonly");
    $("#detail-"+_len+"-4").attr("readonly","readonly");
    $("#detail-"+_len+"-5").attr("readonly","readonly");
    ...
    $("#tab-materaildetail").append("<tr id='new"+nlen+"' align='center'>"
            +"<td><select name='materialdetails_add["+nlen+"].materialName'  style='width:100px' id='detail-"+ nlen +"-1'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialName'/></option></s:iterator></select></td>"
            +"<td><input type='text' name='materialdetails_add["+ nlen +"].orderMaterialAttr' id='detail-"+ nlen +"-2'  style='width:100px'></td>"
            +"<td><select name='materialdetails_add["+nlen+"].materialType'  style='width:100px' id='detail-"+ nlen +"-3'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialType'/></option></s:iterator></select></td>"
            +"<td><select name='materialdetails_add["+nlen+"].colorCode'  style='width:100px' id='detail-"+ nlen +"-4'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.colorCode'/></option></s:iterator></select></td>"
            +"<td><select name='materialdetails_add["+nlen+"].vendorName'  style='width:100px' id='detail-"+ nlen +"-5'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.vendor.vendorName'/></option></s:iterator></select></td>"
...
function deldetailtr(index){
    ...
    var next1,next2,next3,next4,next5,next6,next7;
    for (var i = index + 1, j = _len ; i < j; i++) {
        next1 = $("#detail-" + i +"-1").val();
        next2 = $("#detail-" + i +"-2").val();
        next3 = $("#detail-" + i +"-3").val();
        next4 = $("#detail-" + i +"-4").val();
        next5 = $("#detail-" + i +"-5").val();
        next6 = $("#detail-" + i +"-6").val();
        next7 = $("#detail-" + i +"-7").val();
      
        $("tr[id='new" + i + "']")
                .replaceWith("<tr id='new" + (i - 1) + "' align='center'>"
                        + "<td><select name='materialdetails_add["+(i - 1)+"].materialName' readonly style='width:100px' id='detail-"+ (i - 1) +"-1' value='" + next1 + "'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialName'/></option></s:iterator></select></td>"
                        ...
                        +"<td><select name='materialdetails_add["+(i - 1)+"].materialType' readonly style='width:100px' id='detail-"+ (i - 1) +"-3' value='" + next3 + "'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialType'/></option></s:iterator></select></td>"
                        +"<td><select name='materialdetails_add["+(i - 1)+"].colorCode' readonly style='width:100px' id='detail-"+ (i - 1) +"-4' value='" + next4 + "'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.colorCode'/></option></s:iterator></select></td>"
                        +"<td><select name='materialdetails_add["+(i - 1)+"].vendorName' readonly style='width:100px' id='detail-"+ (i - 1) +"-5' value='" + next5 + "'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.vendor.vendorName'/></option></s:iterator></select></td>"
    ...
    $("tr[id='new" +(_len) + "']")
            .replaceWith("<tr id=new" + (_len - 1) + " align='center'>"
            	      +"<td><select name='materialdetails_add["+(_len - 1)+"].materialName'  style='width:100px' id='detail-"+ (_len - 1) +"-1'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialName'/></option></s:iterator></select></td>"                    
            	      +"<td><input type='text' name='materialdetails_add["+ (_len - 1) +"].orderMaterialAttr' id='detail-"+ (_len - 1) +"-2'  style='width:100px'></td>"
            	      +"<td><select name='materialdetails_add["+(_len - 1)+"].materialType'  style='width:100px' id='detail-"+ (_len - 1) +"-3'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.materialType'/></option></s:iterator></select></td>"
                      +"<td><select name='materialdetails_add["+(_len - 1)+"].colorCode'  style='width:100px' id='detail-"+ (_len - 1) +"-4'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.material.colorCode'/></option></s:iterator></select></td>"
                      +"<td><select name='materialdetails_add["+(_len - 1)+"].vendorName'  style='width:100px' id='detail-"+ (_len - 1) +"-5'><s:iterator value='supplyList' var='supply'><option><s:property value='#supply.vendor.vendorName'/></option></s:iterator></select></td>"
