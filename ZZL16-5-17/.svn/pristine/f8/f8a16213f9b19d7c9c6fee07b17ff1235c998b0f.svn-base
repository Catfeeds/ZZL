						...
						<div class="table-responsive" style="margin: 0px 50px 50px 23px">
							<table class="table table-striped">
								...
								<s:iterator value="PageBean.list" var="bomItem">
									<tr>
										<td><input type="radio" name="select"><input type="hidden" name="selectedID" value=${bomItem.designCode}></td>
		...
		$('#putawayDate').datetimepicker({
			...
			forceParse : 0,
		     ...
		     function getBom(){
        		...
        		if(selectedID != null){        			
        			location.href= getRootPath() + "/Bom/getBom?designCode="+selectedID;     	       		         
        		}else{
        			alert("请选择");
        		}
        	}
