		...
		<aside class="right-side">
	       ...
	       <section class="content">
	           ...
	           <div class="input-group" id="order_id">
	            ...
	            <input type="text" id="orderCode" class="form-control" placeholder="订单编号" style="padding: 2px 10px;" >                 
	           </div>
	
	           <div class="input-group" id="consumer_num">
	            <label for="name">客户名称</label>
	            <input type="text" id="customerName" class="form-control" placeholder="客户名称" style="padding: 2px 10px;">                 
	           </div>
	           ...
	           <div class="form-group">
	               ...
	               <select id="productionProgerss" class="form-control" >
	                <option>请选择</option>
	                <option>外发加工中</option>
	                <option>部分收货</option>
	                <option>完整收货</option>
    ...
    <script type="text/javascript">
        ...
        function searchOrders(){
            $("#search-orders").click(function() {
                ...
                var productionProgress = $("#productionProgerss option:selected").text();
