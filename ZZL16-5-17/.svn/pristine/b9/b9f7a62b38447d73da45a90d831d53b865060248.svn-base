 	...
 	<div class="row">
         <div class="col-md-12">
               <div class="box box-primary">
 				<!-- 查询 -->
                     <form  role="form" method="post" action="<%=request.getContextPath()%>/Purchase/searchAccessoryPurchaseList">
...
<!-- 模态框（Modal） -->
				...
				<div class="modal-body">
                    <div style="word-break:break-all">
                     ...
                     <table class="table table-striped" id="materialExamineTable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeAccessoryState" method="post">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeAccessoryState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									...
									<td>状态：</td>
									<td ><input type="text" name="changeState" id="changeState3"  style="width:170px" readonly="true"></td>
									<td style="width:40px"></td>
									<td><button type="submit" class="btn btn-danger" style="margin:auto">
											审核</button></td>
								</tr>
    ...
    startView : 2,
    	...
    	<script type="text/javascript">
    	window.onload = changeTab("10500","10502");
    	</script>
