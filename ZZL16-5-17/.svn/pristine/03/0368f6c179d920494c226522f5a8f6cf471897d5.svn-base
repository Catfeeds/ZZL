...
<body class="skin-blue">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-header">
                                <h3 class="box-title">工艺单积压趋势图</h3>
                            </div><!-- /.box-header -->
                            ...
                            <div class="row">
                                <!-- 查询   -->
                                 <div class="col-md-10">
                                    <!-- form start -->
                                   <!--    <form  role="form" method="post" action="<%=request.getContextPath()%>/ConditionSheets/searchedTechniqueConditionSheet">         -->             
                                        ...
                                        <div class="row" >
                                               ...
                                               <div class="col-md-2">
                                                     <button type="submit" class="btn btn-primary" id="searchButton" style="margin-top: -6px" 
                                                         onclick="techniqueCondition(document.getElementById('type').value,document.getElementById('date').value)">查询</button>
                                               </div>
                                        </div>
                                   <!--  </form> -->
                                </div>
    ...
    <script type="text/javascript">
         //windows.onload = changeTab("11300","11301");
         
         function techniqueCondition(type,date) { 
        	 var xtext = [];
    		 var list = [];
        	 params = {
        			 "typeAjax":type,
        	 ...
        	 jQuery.post("/ZZL/ConditionSheets/techniqueConditionAjax",params,function(data){
        		 json = eval("("+data+")");
