	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form action="<%=request.getContextPath()%>/Process/addOutSource" method="post">
							...
							<div class="box-body">
								...
								<table style="padding: 15px; margin: 20px">
									<tr>
										...
										<td><input type="text" name="outSourceCode"></td>
									...
									<tr>
										...
										<td><input type="text" class="date-picker" name="finishDate"></td>
										<td class="out-info">排单时间：</td>
										<td><input type="text" class="date-picker" name="osScheduleDate"></td>
									</tr>
									<tr>
										<td class="out-info">订单状态：</td>
										<td><input type="text" name="outSourceState"></td>
										<td class="out-info">订单优先级：</td>
										<td><select name="outSourceRank">
						...
						<div class="col-md-12">
							<div class="table-responsive" style="margin: 10px 15px 20px 23px">
								<table class="table table-striped" id="tab-detail">
									...
									<tr id="0">
										<td><input type="text" name="details_add[0].outsourceColor"
											id="detail-0-color"></td>
										<td><input type="text" name="details_add[0].outsourceXS"
											id="detail-0-xs" value="0"></td>
										...
										<td><input type="text" name="details_add[0].outsourceXL"
											id="detail-0-xl" value="0"></td>
										<td><input type="text" name="details_add[0].outsourceXXL"
											id="detail-0-xxl" value="0"></td>
										<td><input type="text" name="details_add[0].outsourceTotal"
											id="detail-0-sum" value="0" disabled></td>
										<td>
							...
							<div class="box-body">
								<table style="padding: 10px; margin: 10px">
									<tr>
										...
										<td><input type="text" name="labourCost"></td>
										<td class="out-info">加工方：</td>
										<td><input type="text" name="processorCode"></td>
										<td class="out-info">实际外发时间：</td>
										<td><input type="text" class="date-picker" name="actualOutDate"></td>
									</tr>
									<tr>
    ...
    var deltr = function (index) {
        ...
        for (var i = index + 1, j = _len ; i < j; i++) {
            ...
            $("tr[id=\'" + i + "\']")
                    .replaceWith("<tr id=" + (i - 1) + " align='center'>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceColor' value='" + nextColor + "' id='detail-"+ (i - 1) +"-color' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceXS' id='detail-"+ (i - 1) +"-xs' value='" + nextXS + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceS' id='detail-"+ (i - 1) +"-s' value='" + nextS + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceM' id='detail-"+ (i - 1) +"-m' value='" + nextM + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceL' id='detail-"+ (i - 1) +"-l' value='" + nextL + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceXL' id='detail-"+ (i - 1) +"-xl' value='" + nextXL + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceXXL' id='detail-"+ (i - 1) +"-xxl' value='" + nextXXL + "' readonly></td>"
                            + "<td><input type='text' name='details_add["+ (i - 1) +"].outsourceTotal' id='detail-"+ (i - 1) +"-sum' value='" + nextSUM + "' readonly></td>"
        ...
        $("tr[id=\'" + (_len) + "\']")
                .replaceWith("<tr id=" + (_len - 1) + " align='center'>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceColor'  id='detail-"+ (_len - 1) +"-color'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceXS' id='detail-"+ (_len - 1) +"-xs' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceS' id='detail-"+ (_len - 1) +"-s' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceM' id='detail-"+ (_len - 1) +"-m' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceL' id='detail-"+ (_len - 1) +"-l' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceXL' id='detail-"+ (_len - 1) +"-xl' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceXXL' id='detail-"+ (_len - 1) +"-xxl' value='0'></td>"
                        + "<td><input type='text' name='details_add["+ (_len - 1) +"].outsourceTotal' id='detail-"+ (_len - 1) +"-sum' value='0' readonly></td>"
