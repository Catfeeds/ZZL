...
<body class="skin-blue">
 <!-- header logo: style can be found in header.less -->
	           ...
	           <tr>
				...
				<tr>
                                   ...
                                   <td><s:property value="#TailorManageVO.outsourceCode" />
					                    ...
					                    <br/>
					                    <a style="white-space:nowrap;"><label class="bc"><font color="red">开始时间：<s:property value="#TailorManageVO.tailorStartingTime"/></font></label></a></td>
					               ...
					               <td><a style="white-space:nowrap;"><font color="blue">排版：</font><font color="green">
					               <a href=""  data-toggle="modal"  onclick="javascript:getAllCharge(1,<s:property value="#TailorManageVO.outsourceID"/>,'排版');"
	data-target="#addProcessor"><s:property value="#TailorManageVO.tailorModelName" /></a></font></a>
	...
	data-target="#addProcessor"><s:property value="#TailorManageVO.tailorTailorName" /></a></font></a></td>
