	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="input-group">
								<span>联系方式：</span> <span class="red">*</span><input id="contact"
									type="text" class="form-control form-input" maxlength="20"
									value="${productionVO.contact}">
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<!-- .col-md-8 -->
				<div class="col-md-4">
					<img src="${productionVO.picUrl}" class="commdity-graph">
				</div>
				<!-- .col-md-4 -->
			</div>
			<!-- .row -->
